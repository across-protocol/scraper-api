...
export class UserWallet1663926413026 implements MigrationInterface {
  name = "UserWallet1663926413026";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user_wallet" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "walletAddress" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UK_userWallet_userId" UNIQUE ("userId"), CONSTRAINT "UK_userWallet_id_walletAddress" UNIQUE ("id", "walletAddress"), CONSTRAINT "REL_f470cbcba8c6dbdaf32ac0d426" UNIQUE ("userId"), CONSTRAINT "PK_b453ec3d9d579f6b9699be98beb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
